...
<body>
 ...
 <div class=" category bg-image obj-fit-cover container-fluid py-4" style="background-image: url('https://cdn.pixabay.com/photo/2021/04/11/16/02/gradient-6170176_1280.jpg'); height:45.5vh; width: 100vw   background-size: cover;">
   ...
   <h4 style="padding-bottom: 20px;"><cente>ADMIN HOME</center></h4>
...
<a href="replyQuestions.jsp" id="btn1"class="btn btn-rounded">Customer Profile</a></button></span>
<span style="float : right; ">
<a href="notAnsweredQuestions.jsp" id="btn2"class="btn btn-rounded">Driver Profile</a></span>
</h2>
<br>
